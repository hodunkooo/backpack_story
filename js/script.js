...
(function () {
	...
	$(function () {
		...
		/**
		 * @desc Sets slides background images from attribute 'data-slide-bg' without animation
		...
		function setBackgrounds(swiper) {
			...
			for (let i = 0; i < swipersBg.length; i++) {
				...
				// Видаляємо transition та animation
				swiperBg.style.transition = '';
				swiperBg.style.animation = '';
				// Видаляємо backgroundSize та backgroundPosition, щоб вони залишилися по замовчуванню
				swiperBg.style.backgroundSize = '';
				swiperBg.style.backgroundPosition = '';
			}
		}
